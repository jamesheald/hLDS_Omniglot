...
def create_data_split(cfg):
    ...
    tfds.load('Omniglot', split = [train_str, test_str], shuffle_files = True, as_supervised = False, with_info = True)
    ...
    train_dataset = transform_train_dataset(train_dataset, cfg.batch_size, cfg.tfds_seed)
